...
import it.gov.pagopa.anpr.c003.dto.generated.TipoInfoValore;
import it.gov.pagopa.anpr.c030.dto.generated.RispostaE002OK;
import it.gov.pagopa.anpr.c030.dto.generated.TipoDatiSoggettiEnte;
import it.gov.pagopa.anpr.c030.dto.generated.TipoIdentificativi;
import it.gov.pagopa.anpr.c030.dto.generated.TipoListaSoggetti;
...
class AnprServiceImplTest {
    ...
    void givenValidFiscalCodeAndIdAnprWhenGetCitizenDataThenReturnCitizenDetails() {
        ...
        it.gov.pagopa.anpr.c003.dto.generated.RispostaE002OK anprC003Response = newC003RispostaE002Ok();
        ...
        anprC003Response.setListaSoggetti(new it.gov.pagopa.anpr.c003.dto.generated.TipoListaSoggetti(List.of(
                new it.gov.pagopa.anpr.c003.dto.generated.TipoDatiSoggettiEnte(List.of(subTypeInfo))
        )));

        when(anprC030Service.getIdAnprFromFc(fiscalCode, organizationId, subUnitCode, accessToken)).thenReturn(anprC030Response);
        when(anprC003Service.getUserData(idAnpr, organizationId, subUnitCode, accessToken)).thenReturn(anprC003Response);
    ...
    private static it.gov.pagopa.anpr.c003.dto.generated.RispostaE002OK newC003RispostaE002Ok() {
        return new it.gov.pagopa.anpr.c003.dto.generated.RispostaE002OK("IDOP", new it.gov.pagopa.anpr.c003.dto.generated.TipoListaSoggetti(List.of()), List.of());
    }
    ...
    void givenValidFiscalCodeAndInvalidC003ResponseWhenGetCitizenDataThenThrowIllegalArgumentException() {
        ...
        when(anprC030Service.getIdAnprFromFc(fiscalCode, organizationId, subUnitCode, accessToken)).thenReturn(anprC030Response);
        when(anprC003Service.getUserData(idAnpr, organizationId, subUnitCode, accessToken)).thenReturn(null);
    ...
    void givenValidFiscalCodeAndInvalidSubDataTypeWhenGetCitizenDataThenThrowIllegalArgumentException() {
        ...
        anprC003Response.setListaSoggetti(new it.gov.pagopa.anpr.c003.dto.generated.TipoListaSoggetti(null));
    ...
    void givenValidFiscalCodeAndEmptySubDataTypeWhenGetCitizenDataThenThrowIllegalArgumentException() {
        ...
        anprC003Response.setListaSoggetti(new it.gov.pagopa.anpr.c003.dto.generated.TipoListaSoggetti(new ArrayList<>()));
    ...
    void givenServiceUnavailableWhenGetCitizenDataThenThrowRuntimeException() {
        ...
        when(anprC030Service.getIdAnprFromFc(fiscalCode, organizationId, subUnitCode, accessToken)).thenThrow(new RuntimeException("Service unavailable"));
