...
import it.gov.pagopa.payhub.pdnd.exception.PdndServicesExceptionHandler;
import it.gov.pagopa.payhub.pdnd.exception.transcoder.handler.ConstraintViolationExceptionMessageTranscoderTest;
...
import static it.gov.pagopa.payhub.pdnd.exception.transcoder.handler.ConstraintViolationExceptionMessageTranscoderTest.EXPECTED_CONSTRAINT_EXCEPTION_MESSAGE_TRANSCODED;
...
public abstract class CommonExceptionHandlerTest {
  ...
  void handleForbiddenErrorExceptionError() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("PDND_SERVICES_FORBIDDEN"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("ERRORCODE"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Error"))
  ...
  void handleNotAuthorizedExceptionError() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("PDND_SERVICES_UNAUTHORIZED"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("ERRORCODE"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Error"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.fields").doesNotExist())
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  ...
  void handleAuthorizationDeniedException() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      .andExpect(MockMvcResultMatchers.status().isForbidden())
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("PDND_SERVICES_FORBIDDEN"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("PDND_SERVICES_FORBIDDEN"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Error"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.fields").doesNotExist())
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  }
  ...
  void handleConflictExceptionError() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("PDND_SERVICES_CONFLICT"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("ERRORCODE"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Error"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.fields").doesNotExist())
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  ...
  void handleHttpHostConnectionExceptionException() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      .andExpect(MockMvcResultMatchers.status().isInternalServerError())
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("PDND_SERVICES_GENERIC_ERROR"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("PDND_SERVICES_CONNECTION_ERROR"))
