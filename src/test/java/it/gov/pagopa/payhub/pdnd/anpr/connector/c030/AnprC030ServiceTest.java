...
import it.gov.pagopa.anpr.c030.dto.generated.TipoCriteriRicercaE002;
import it.gov.pagopa.anpr.c030.dto.generated.TipoDatiRichiestaE002;
...
class AnprC030ServiceTest {
    ...
    void givenValidFiscalCodeWhenGetIdAnprFromFcThenReturnValidResponse() {
        ...
        when(pdndServiceMock.generateToken(PdndServiceType.ANPR_C030,organizationId,subUnitCode, accessToken))
