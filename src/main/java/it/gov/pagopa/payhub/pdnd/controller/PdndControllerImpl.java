...
import it.gov.pagopa.payhub.pdnd.connector.pdnd.PdndServiceImpl;
...
public class PdndControllerImpl implements P4paPdndApi {
  ...
  public PdndControllerImpl(PdndServiceImpl pdndService,
      ApiClientConfigService apiClientConfigService) {
  ...
  public ResponseEntity<PdndAuthData> getVoucherToken(String service) {
    log.info("voucher for service " + service);
