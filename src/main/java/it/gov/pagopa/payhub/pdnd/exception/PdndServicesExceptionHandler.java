...
public class PdndServicesExceptionHandler {
    ...
    static ResponseEntity<PdndServicesErrorDTO> handleException(Exception ex, HttpServletRequest request, HttpStatusCode httpStatus, PdndServicesErrorDTO.CategoryEnum errorEnum) {
        ...
        return ResponseEntity
                ...
                .body(new PdndServicesErrorDTO(errorEnum, code, String.format(ERROR_MESSAGE_FORMAT, code, message), Utilities.getTraceId()));
    }
    ...
    private static Pair<String, String> buildReturnedMessage(Exception ex) {
        switch (ex) {
            case HttpMessageNotReadableException httpMessageNotReadableException -> {
                ...
                return Pair.of(PdndServicesErrorDTO.CategoryEnum.PDND_SERVICES_BAD_REQUEST.name(), errorMsg);
            }
            case MethodArgumentNotValidException methodArgumentNotValidException -> {
                return Pair.of(PdndServicesErrorDTO.CategoryEnum.PDND_SERVICES_BAD_REQUEST.name(),
