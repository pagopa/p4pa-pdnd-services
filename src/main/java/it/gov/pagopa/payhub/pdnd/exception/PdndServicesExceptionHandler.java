...
public class PdndServicesExceptionHandler {
  ...
  public ResponseEntity<PdndServicesErrorDTO> handleServletException(ServletException ex, HttpServletRequest request) {
  ...
  static ResponseEntity<PdndServicesErrorDTO> handleException(Exception ex, HttpServletRequest request, HttpStatusCode httpStatus, PdndServicesErrorDTO.CodeEnum errorEnum) {
    ...
    return ResponseEntity
      .status(httpStatus)
      .body(new PdndServicesErrorDTO(errorEnum, message));
  }
