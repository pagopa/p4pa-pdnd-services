...
public class PdndService {
  ...
  protected final ConcurrentHashMap<PdndBaseServiceIntegratedConfig, String> jwtCache = new ConcurrentHashMap<>();
  ...
  public String generateToken(PdndBaseServiceIntegratedConfig pdndBaseServiceIntegratedConfig) {
    return jwtCache.compute(pdndBaseServiceIntegratedConfig, (key, existingJwt) -> {
